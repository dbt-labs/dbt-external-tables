...
#}
{% macro maxcompute_alter_table_add_partitions(source_node, partitions) %}
  ...
  {% if partitions|length > 0 %}
    ...
    {%- for partition in partitions -%}
      ...
      {%- endif -%}
        ...
        location '{{ source_node.external.location }}/{%- for part in partition.partition_by -%}{{ part.name }}={{ part.value }}/{% endfor %}'
